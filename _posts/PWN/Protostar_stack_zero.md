...
![](assets/posts/PWN/protostar_stack_zero/maingdb1.png)

i have also loaded this in IDA to view its execution flow.

![](assets/posts/PWN/protostar_stack_zero/mainida1.png)
...
![](assets/posts/PWN/protostar_stack_zero/keyjmp.png)
...
![](assets/posts/PWN/protostar_stack_zero/b_main.png)
...
![](assets/posts/PWN/protostar_stack_zero/b_mov.png)

I will now modify the value of variable X.

![](assets/posts/PWN/protostar_stack_zero/x_aftervalue.png)

This results in the challenge being successfully completed.

![](assets/posts/PWN/protostar_stack_zero/flag.png)
